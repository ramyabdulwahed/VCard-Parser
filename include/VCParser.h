...
char * getFNProperty (Card * obj);
int getLengthOptionalProperties (Card * obj);
char * getBirthdayProperty (Card * obj);
char * getAnniversaryProperty (Card * obj);
char * changeFNPropertyValue (Card * obj, char * newValue);
char * getAnniversaryPropForSQL (Card * obj);
char * getBirthdayPropForSQL (Card * obj);
